<script>
    ...
    import {semesters, participate, szakos_tajekoztatok} from "../../elements/constants";
                ...
                <div class="card mb-6">
                    ...
                    <div class="content">
                        <div class="field ml-5 mr-5">
                            <label class="label has-text-left">{$t('form_content_name')}<b class="has-text-danger">*</b></label>
                            <div class="control">
                    ...
                    <div class="ml-5 mt-6 is-offset-3-mobile">
                        ...
                        <div class="control">
                            <label class="checkbox">
                                ...
                                {$t('form_content_oath')}<b class="has-text-danger">*</b>
                            </label>
                        </div>
                    </div>
                    <div class="field ml-5 mt-6 is-offset-3-mobile">
                        <div class="control">
                            <label class="checkbox">
                                ...
                                {$t('form_content_privacy_notice')}<b class="has-text-danger">*</b>
                            </label>
                        </div>
                    </div>
                    <div class="buttons ml-5 mt-6">
                        ...
                        <Button type="is-info" outlined>Teszt</Button>
                    </div>
                </div>
            </div>
        </div>
